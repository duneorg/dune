...
// Tests — mediaHandler
// ---------------------------------------------------------------------------
// NOTE: Public /api/* endpoints are covered by tests/api/handlers_test.ts,
// which exercises the shared createApiHandler used in production. The legacy
// duneRoutes.apiHandler was removed.
